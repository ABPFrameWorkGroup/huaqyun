<!--
 * @Author: your name
 * @Date: 2020-03-20 11:09:53
 * @LastEditTime: 2020-03-20 12:30:50
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \Learing\web\huaqyun\docs\zh-cn\server.md
 -->
<!-- ## 分层架构体系 -->

### 前言

为了减少复杂性和提高代码的可重用性，采用分层架构是一种被广泛接受的技术。为了实现分层的体系结构，医信平台遵循DDD（领域驱动设计）的原则，将工程分为四个层：
...
* **基础设施层(Infrastructure)**：提供通用技术来支持更高的层。例如基础设施层的仓储(Repository)可通过ORM来实现数据库交互，或者提供发送邮件的支持。根据实际需要，可能会有额外添加的层。例如：
